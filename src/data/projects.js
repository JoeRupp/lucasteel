const allProjects = [
  {
    ...
    bannerImage: "projectPhotos/furniture/furniture_8.jpg",
    images: [
  ...
  },
  {
    ...
    bannerImage: "projectPhotos/ridgeAt38/ridge_at_38_6.jpg",
    images: [
  ...
  {
    id: 5,
    title: "Black Oxide Patina",
    description:
      "We pride ourselves on our ability to do unique finishes on steel, making a piece even more custom and one of a kind. This black oxide patina is a reaction that physically changes the outer surface of the steel allowing for a depth of feel not possible with paint. The patina gives the detail of the steel to be seen rather than covered and hidden.",
    bannerImage: "projectPhotos/blackOxidePatina/black_oxide_3.jpg",
    images: [
      "projectPhotos/blackOxidePatina/black_oxide_1.jpg",
      "projectPhotos/blackOxidePatina/black_oxide_2.jpg",
      "projectPhotos/blackOxidePatina/black_oxide_3.jpg",
    ],
  },
  {
    id: 6,
